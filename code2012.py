...
i = 0
url = "http://www.imdmumbai.gov.in/scripts/detail.asp?releaseid=E2012RF"
...
def getdata(str):
    try:
        ...
        city = open('E:\ProjectFlood\mumbai_city12.csv', 'ab')
        city_writer = csv.writer(city, delimiter=',')
        city_writer.writerow([date, city_rain])
        city.close()
        sub = open('E:\ProjectFlood\mumbai_sub12.csv', 'ab')
