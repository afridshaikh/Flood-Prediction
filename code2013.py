...
i = 0
url = "http://www.imdmumbai.gov.in/scripts/detail.asp?releaseid=E2013RF"
...
def getdata(str):
    try:
        ...
        city = open('E:\ProjectFlood\mumbai_city13.csv', 'ab')
        city_writer = csv.writer(city, delimiter=',')
        city_writer.writerow([date, city_rain])
        city.close()
        sub = open('E:\ProjectFlood\mumbai_sub13.csv', 'ab')
