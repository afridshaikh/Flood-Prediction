...
i = 2
url = "http://www.imdmumbai.gov.in/scripts/detail.asp?releaseid=E2010RF"
...
def getdata(str):
    try:
        ...
        city = open('E:\ProjectFlood\mumbai_city10.csv', 'ab')
        city_writer = csv.writer(city, delimiter=',')
        city_writer.writerow([date, city_rain])
        city.close()
        sub = open('E:\ProjectFlood\mumbai_sub10.csv', 'ab')
